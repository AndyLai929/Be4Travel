...
1. Call Memverse `search_memory` with query: "learnings for Be4Travel"
2. Display in table format:

```
RECENT LEARNINGS (Be4Travel)
═══════════════════════════════════════════════════
  #  Type         Key                    Confidence
...
1. Call Memverse `search_memory` with the user's query and domain: "Be4Travel"
...
2. Call Memverse `search_memory` with these topics and domain "Be4Travel"
...
- **Domain isolation** — always scope to "Be4Travel" domain
